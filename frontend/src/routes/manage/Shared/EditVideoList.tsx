...
import { LuCalendar, LuUserCircle } from "react-icons/lu";
import {
    boxError,
    Button,
    Floating,
...
export const ManageVideoListContent = <TMutation extends MutationParameters>({
    ...
    const onSubmit = () => commit({
        ...
        onError: e => {
            setSuccess(false);
            setCommitError(displayCommitError(e, "some error"));
        },
    });
    ...
    return <Inertable isInert={inFlight} css={{ marginBottom: 32, maxWidth: 750 }}>
        ...
        {description && <p css={{ marginBottom: 8, maxWidth: 750 }}>
            {description}
        </p>}
        ...
        {events.length > 0 && <>
            <div css={{
                ...
                {events.map(event => <EventEntry
                    key={event.id} {...{ event, events, setEvents }}
                />)}
            </div>
                ...
                <div css={{
                    ...
                    <div css={{
                        ...
                        {event.action === "add" && <>
                            ...
                            <Button css={buttonStyle} onClick={() => setEvents(
