...
export type SharedManageAssetNavProps = {
    active: ManageSubPageType;
};

/** Simple nav element linking back to the asset table overview page. */
type BackLinkProps = {
    url: "/~manage/series" | "/~manage/videos";
    title: ParseKeys;
};
export const BackLink: React.FC<BackLinkProps> = ({ url, title }) => {
...
type ManageAssetNavProps = SharedManageAssetNavProps & {
    link: string;
    ariaLabel: string;
    title: string;
    thumbnail: ReactNode;
...
export const ManageAssetNav: React.FC<ManageAssetNavProps> = ({
    active,
    link,
    ariaLabel,
    title,
